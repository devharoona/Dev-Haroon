...
- Hey there! So you want to learn programming. Awesome choice! It might
- seem complex, but the basic funda (fundamental concept) is very simple.

-  he computer is like a very obedient but very dumb chef. It will do exactly what you tell it to, in the exact order you tell it. Your "recipe" is the code, and the programming language is the language you use to write it.
